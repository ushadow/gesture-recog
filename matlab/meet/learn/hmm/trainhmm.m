...
for i = 1 : param.vocabularySize
  ...
  if ~isempty(XByClass{i})
    ...
    if nS > 1
      [mu0, Sigma0, mixmat0] = inithmmparamviterbi(XByClass{i}, nS, param.nM(1), param.XcovType);
...
%           XByClass{i}, nS, param.nM(1), param.XcovType, 2, rep);
      [prior0, transmat0, mu0, Sigma0, mixmat0, term0] = trainviterbi(XByClass{i}, ...
          prior0, transmat0, mu0, Sigma0, mixmat0, 'term', term0, 'cov_type', param.XcovType, ...
          'max_iter', 1);
...
%       [~, model.prior{i}, model.transmat{i}, model.mu{i}, model.Sigma{i}, ...
%           model.mixmat{i}, model.term{i}] = mhmm_em(XByClass{i}, prior0, ...
%           transmat0, model.mu{i}, model.Sigma{i}, model.mixmat{i}, 'adj_prior', 1, ...
%           'max_iter', param.maxIter, 'cov_type', param.XcovType, ...
%           'adj_Sigma', 1, 'term', term0);
    else
