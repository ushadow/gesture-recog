function master_train_hj_perbatch(vid_file_string, path, MTY)
...
num_unsup_samples_per_clip = [100; 100; 100];
...
%     extract_unsupervised_training_data_hw2_hj(vid_file_string, data_path_file_name{i}, params_ex, MTY, batchz); 
    extract_unsupervised_training_data_hw2_hj_perbatch(vid_file_string, data_path_file_name{i}, params_ex, MTY); 
end
