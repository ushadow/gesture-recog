function [scorestoim, scorestotemp, best_scales] = chamfer_multiscale2(edge_image, template, scales, ft_interior)
...
ft_interior = imresize( double(ft_interior), sample_rate, 'bilinear');
